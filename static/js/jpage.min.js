...
(function(e) {
	...
	jQuery.fn.jpage.animation.before = function(b, d, c, a) {
		...
		for (var e = 0; e < c.length; e++)
			if (b = c.eq(e), g = b.data("jpage.item")) b.css({
				top: f,
				opacity: 0,
				left: 0
	...
	jQuery.fn.jpage.animation.getRandomEffect = function() {
		var b = ["crossfade", "bricks", "slideLeft", "slideRight"],
			d;
...
(function(e) {
	...
	jQuery.fn.jpage.animation.noEffect.before = function(b, d, c, a) {
		...
		for (var f = 0; f < c.length; f++) a = c.eq(f), g = a.data("jpage.item"), a.css({
			top: b
		}), b += g.heightPBM;
...
(function(e) {
	...
	jQuery.fn.jpage.animation.bricks.effect = function(b, d, c, a, g) {
		...
		if (a)
			for (d = 0; d < a.length; d++) b = a.eq(d), 0 === d % 2 ? b.css({
				opacity: (100 - g) / 100,
				left: -g + "%"
			}) : b.css({
				opacity: (100 - g) / 100,
...
//					0 < a.currentPage && (b += '<li data-page="0">' + c.options.firstPageText + "</li>");
					0 < a.currentPage && (b += '<li data-page="' +
						(a.currentPage - 1) + '" style="width:100px;background-color:#ffffff;border:1px solid #ffffff;color:#999999">' + c.options.firstPageText+'上一页' + "</li>");
					for (var h = 0; h < a.pagesNumber; h++) e = a.currentPage === h ? ' class="active"' : "", d = h + 1, b += '<li data-page="' + h + '"' + e + ">" + d + "</li>";
					a.currentPage < a.pagesNumber - 1 && (b += '<li data-page="' + (a.currentPage + 1) + '" style="width:100px;background-color:#ffffff;border:1px solid #ffffff;color:#999999">' + '下一页'+c.options.lastPageText + "</li>");
